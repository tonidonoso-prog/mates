...
LECTURA_WORDS = {
    "Fàcil": ["CASA", "GAT", "SOL", "PAPA", "MAMA", "PA", "MÀ", "SOPA", "BOLA", "RODA", "NEN", "NENA", "GOS", "LLIT", "PEIX"],
    "Normal": ["FINESTRA", "ESTRELLA", "SABATA", "PILOTA", "GIRAFA", "GAT I GOS", "CASA GRAN", "UN PARE", "LA MARE", "SOL I LLUNA", "ELEFANT", "MOTXILLA"],
    "Difícil": ["ESQUIROL VELOÇ", "ORDINADOR VELL", "LLIBRETA NOVA", "ESTRABÒS DIVERTIT", "FRIGORÍFIC BLANC", "CONEIXEMENT PROFUND", "BOLÍGRAF BLAU", "MATEMÀTIQUES FÀCILS"]
}
