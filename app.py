...
LECTURA_WORDS = {
    "Fàcil": ["CASA", "GAT", "SOL", "PAPA", "MAMA", "PA", "MÀ", "SOPA", "BOLA", "RODA", "NEN", "NENA", "GOS", "LLIT", "PEIX", "MAR", "CEL", "POC", "MOLT", "BONA", "DALT", "BAIX", "LLUM", "FOC", "DIU", "VEU", "RIU", "PIS", "TREM", "COSA", "LLUNA", "PILA", "TAULA"],
    "Normal": ["FINESTRA", "ESTRELLA", "SABATA", "PILOTA", "GIRAFA", "GAT I GOS", "CASA GRAN", "UN PARE", "LA MARE", "SOL I LLUNA", "ELEFANT", "MOTXILLA", "CARAMEL", "FORQUILLA", "CULLERA", "ESCRIPTORI", "BICICLETA", "PANTALONS", "SAMARRETA", "CADIRA BLAVA", "PORTA OBERTA", "FINESTRA TANCADA", "MENJAR SA"],
    "Difícil": ["ESQUIROL VELOÇ", "ORDINADOR VELL", "LLIBRETA NOVA", "ESTRABÒS DIVERTIT", "FRIGORÍFIC BLANC", "CONEIXEMENT PROFUND", "BOLÍGRAF BLAU", "MATEMÀTIQUES FÀCILS", "ENCICLOPÈDIA GRAN", "TRANSFORMACIÓ MÀGICA", "RECONEIXEMENT RÀPID", "EXCURSIÓ AL MUNTANYA", "VIATGE INTERSTEL·LAR", "PARAULA COMPLICADA", "BIBLIOTECA PÚBLICA"]
}
